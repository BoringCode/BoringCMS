...
?>
      <div class="content">
        <div class="page-header">
          <h1><?php if(ifPage($page) === true){ echo ucfirst($page); } else { echo "404"; } ?> <small>Welcome to BoringCMS</small></h1>
        </div>
        <div class="row">
          <div class="span10">
			<?php if (ifPage($page) !== true) { ?>
			...
			<?php } else {
				...
				<p>Please <a href="<?php echo adminURL($dbc) . $mr_notactive . "login"; ?>">login</a> to acccess the admin panel.</p>
				<?php 
				}
				}
			}?>
